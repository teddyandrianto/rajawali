    ...
    <div class="row">
      ...
      <div class="media">
        ...
        <div class="media-body">
          <p class="judul">Jaket Hitam</p>
          <hr>
          <p class="harga">Rp <span id="harga">100000</span></p>
          <p class="stok">Stok Barang : <b>11</b> <br> Berat : <b id="berat">3</b> Kg</p>
          <form name="form" method="POST" action="http://localhost/aumddy/index.php/web/keranjang_tambah">
           <div class="btn-group">
          ...
          <b>Deskripsi :</b>
          <p>Kaos Superhero Black Panther Mask adalah kaos dengan kualitas distro. tersedia Warna Hitam. Bahan Kaos tersedia 2 macam : Cotton Combed 20s dan Cotton Combed 30s Bahan sama-sama katun, hanya berbeda ketebalan saja. 20s yang lebih tebal. 30s yang lebih tipis.</p>
            ...
            <div class="row">
              <div class="col-md-4"> 
               <div class="form-group">
                  ...
                  <select id="kurir" name="id_provinsi" class="form-control" >
